...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        loginButton.addTarget(self,
                              action: #selector(didTappedLoginButton),
                              for: .touchUpInside)
        ...
        termsButton.addTarget(self,
                              action: #selector(didTappedTermsButton),
                              for: .touchUpInside)

        privacyButton.addTarget(self,
                                action: #selector(didTappedPrivacyButton ),
                                for: .touchUpInside)
    ...
    private func configureHeaderView() {
        ...
        // add instagramm name Logo
        let imageView = UIImageView(image: UIImage(named: "nameLogo")?.withTintColor(.white))
    ...
    @objc private func didTappedLoginButton() {
        ...
        guard let usernameEmail = usernameEmailField.text,
              ...
              let password = usernameEmailField.text,
