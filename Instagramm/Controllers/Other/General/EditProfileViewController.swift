...
final class EditProfileViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Cansel",
                                                            style: .plain,
                                                            target: self,
    ...
    private func createTableHeaderView() -> UIView {
        ...
        let profilePhotoButton = UIButton(frame: CGRect(x: (view.width - size) / 2.0,
                                                        y: (header.height - size) / 2.0,
                                                        width: size,
                                                        height: size ))
