...
final class ProfileViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        layout.sectionInset = UIEdgeInsets(top: 0, left: 1,
                                           bottom: 0, right: 1)
        ...
        collection.register(ProfileInfoHeaderCollectionReusableView.self,
        ...
        collection.register(ProfileTabsCollectionReusableView.self,
...
extension ProfileViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        // get the model and post view controller
        //let model = userPosts[indexPath.row]
...
extension ProfileViewController: ProfileInfoHeaderCollectionReusableViewDelegate {
    ...
    func profileHeaderDidTapFollowersButton(_ header: ProfileInfoHeaderCollectionReusableView) {
        let vc = ListViewController(data: ["John", "John", "John", "John"])
        vc.title = "Followers"
        vc.navigationItem.largeTitleDisplayMode = .never
        navigationController?.pushViewController(vc, animated: true)
    }
...
extension ProfileViewController: ProfileTabsCollectionReusableViewDelegate {
    ...
    func didTapTaggedGridButtonTab() {
